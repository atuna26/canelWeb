...
const TileGallery = () => {
  return (
    <section className={`flex flex-col w-full justify-center items-center gap-3`}>
      <h2 className='text-primary text-3xl font-medium tracking-wide font-abel'> <span className="border-t-2 border-l-2 pl-1">Ebatlı</span> ve<span className="border-b-2 border-r-2 pr-1"> Fayans</span> </h2>
      <div className={`flex md:flex-row flex-col w-full justify-center items-center gap-3 `}>
        <img src={slabGalleryA} className="w-[180px] h-[350px]" alt="" />
        <img src={slabGalleryA} className="w-[180px] h-[350px]" alt="" />
        <img src={slabGalleryA} className="w-[180px] h-[350px]" alt="" />
      </div>    
      <button
